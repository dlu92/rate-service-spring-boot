    ...
    public static RateEntity map(RateRequest rateRequest) {
        ...
        try {
            return new RateEntity(
                ...
                new RateStartDate((new SimpleDateFormat("yyyy-MM-dd")).parse(rateRequest.getStartDate())),
                new RateEndDate((new SimpleDateFormat("yyyy-MM-dd")).parse(rateRequest.getStartDate())),
