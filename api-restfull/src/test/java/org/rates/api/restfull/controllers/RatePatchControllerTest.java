...
import org.rates.application.rates.update.RateUpdatedImp;
...
public class RatePatchControllerTest {
    ...
    @Mock
    private RateUpdated rateUpdated;

    @InjectMocks
    private RatePatchController ratePatchController;
    ...
    public void testPatchRate() {
        ...
        when(this.rateUpdated.update(any(Long.class), any(RateEntity.class))).thenReturn(rate);

        ResponseEntity<RateResponse> response = this.ratePatchController.update(RATE_ID, rateRequest);
        ...
        verify(this.rateUpdated).update(any(Long.class), any(RateEntity.class));
